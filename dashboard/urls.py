...
urlpatterns = [
    ...
    path("combo/", catalog.ComboListView.as_view(), name="combo-list"),
    path("combo/create/", catalog.combo_create, name="combo-create"),
    path("combo/<int:pk>/edit/", catalog.combo_update, name="combo-update"),
    path("combo/<int:pk>/delete/", catalog.ComboDeleteView.as_view(), name="combo-delete"),
